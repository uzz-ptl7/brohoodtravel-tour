# 🚀 Quick Start Guide - Brotherhood Company Website
...
- **Phone 1**: +250 786 425 200 ✅
- **Phone 2**: +250 788 485 847 ✅
...
| --------------------- | ----------------------------------------------------- |
| View All Destinations | Home page → Destinations section                      |
...
| Browse FAQs           | Home page → FAQ section                               |
| Share Destinations    | Open any destination → Share button                   |
| Book a Tour           | Click any destination → Book Now                      |
| Contact Form          | Home page → Get In Touch section                      |
